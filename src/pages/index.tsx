  ...
  return (
    <Layout>
      <div className="py-8 px-4">
        ...
        <div className="mt-6">
          <p>
            you can add and edit from blog post. if you are insert, this post will be insert into
            local storage. Whilst static page reavalidate in the background.
          </p>
          <small className="text-slate-600">
            For example, below is a sample of blog can be edit.
          </small>
        </div>
      </div>
